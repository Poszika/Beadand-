...
class EgyagyasSzoba(Szoba):
    def __init__(self, szobaszam):
        super().__init__(szobaszam, 20000)  # Példaként az egyágyas szoba ára 10000 HUF

class Ketagyasszoba(Szoba):
    def __init__(self, szobaszam):
        super().__init__(szobaszam, 35000)  # Példaként a kétágyas szoba ára 15000 HUF
...
szalloda.uj_szoba(EgyagyasSzoba("1"))
szalloda.uj_szoba(Ketagyasszoba("2"))
szalloda.uj_szoba(EgyagyasSzoba("3"))

foglalaskezelo = FoglalasKezelo(szalloda)
foglalaskezelo.foglalas("1", "2024-05-15")
foglalaskezelo.foglalas("2", "2024-05-16")
foglalaskezelo.foglalas("2", "2024-05-17")
foglalaskezelo.foglalas("2", "2024-05-18")
foglalaskezelo.foglalas("3", "2024-05-19")

# Felhasználói interfész
print("Üdv1özöljük a Teszt Szállodában!")
while True:
    print("\nVálasszon műveletet:")
    print("1 - Foglalás")
    print("2 - Lemondás")
